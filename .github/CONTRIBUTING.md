# Contributing<br>to `github-resource-converter`

[![PRs Welcome][makeapullrequest-image]][makeapullrequest-url] We welcome contributors, issues, and pull requests.

<blockquote>
<dfn><strong>Contributions</strong> start with <strong>community conversations</strong> that lead to <strong>positive change.</strong></dfn> <code>github-resource-converter's</code> open source collaboration model has five steps:
...
* ### 1.1. Create Issues for feature requests and defects.
  ...
  > ⌦ `github-resource-converter` follows an issue-driven product delivery model.
...
* ### 3.2. Use ESLint to analyze source code.
  ...
  View [`github-resource-converter's` ESLint rules][eslint-rules-table-url] and their enforcement.
...
│   │       └── db
│   │           └── en
│   │               ├── github-resource-converter-lexion.fixture.json
│   │               └── conventional-commit-types.fixture.json
│   ├── adaptor
│   │   └── conventional-commits-adaptor.test.js
│   └── lib
│       ├── github-resource-converter.test.js
│       ├── lexical-entry.test.js
│       └── lexicon-factory.test.js
├── dir-structure.log
├── docs
│   ├── img
│   │   ├── icons8
│   │   │   ├── contribution-lifecycle-create-issue.png
│   │   │   ├── contribution-lifecycle-pr.png
│   │   │   ├── git-logo.png
│   │   │   ├── icon-alert-50.png
│   │   │   ├── icon-bad-decision-50.png
│   │   │   ├── icon-badge-50.png
│   │   │   ├── icon-beginner.png
│   │   │   ├── icon-bitbucket-20.png
│   │   │   ├── icon-conversation-50.png
│   │   │   ├── icon-data-transfer.png
│   │   │   ├── icon-defect-50.png
│   │   │   ├── icon-developer-filled.png
│   │   │   ├── icon-equality-50.png
│   │   │   ├── icon-git-commit.png
│   │   │   ├── icon-git-compare.png
│   │   │   ├── icon-git-fork.png
│   │   │   ├── icon-git-merge-square-80.png
│   │   │   ├── icon-git-merge.png
│   │   │   ├── icon-git-pr.png
│   │   │   ├── icon-git-pull-request-filled-square-80.png
│   │   │   ├── icon-github-filled-20.png
│   │   │   ├── icon-globe-50.png
│   │   │   ├── icon-good-decision-50.png
│   │   │   ├── icon-help-48.png
│   │   │   ├── icon-help.png
│   │   │   ├── icon-info-30.png
│   │   │   ├── icon-info-50.png
...
│   │   │   ├── icon-justice-50.png
│   │   │   ├── icon-label-50.png
│   │   │   ├── icon-leadership-filled.png
│   │   │   ├── icon-module.png
│   │   │   ├── icon-network-quadrant.png
│   │   │   ├── icon-pledge-50.png
│   │   │   ├── icon-pr.png
│   │   │   ├── icon-quote-left-25.png
│   │   │   ├── icon-request-service-filled-issue-80.png
│   │   │   ├── icon-rest-api.png
│   │   │   ├── icon-rest-client.png
│   │   │   ├── icon-source-code.png
│   │   │   ├── icon-volunteering-filled-80.png
│   │   │   ├── icon-volunteering-filled.png
│   │   │   ├── icons-git-filled-square-80.png
│   │   │   ├── icons-iss-issues-service-filled-80.png
│   │   │   ├── img-instructions-25.png
│   │   │   └── img-instructions.png
│   │   ├── logo-commonalaxy.png
│   │   ├── logo-eslint.png
│   │   ├── logo-jest.png
│   │   ├── logo-osi.png
│   │   ├── logo.sample.png
...
│           │   ├── lib
│           │   │   ├── adaptor
│           │   │   │   ├── conventional-commits-adaptor.js.html
│           │   │   │   └── index.html
│           │   │   ├── cli
│           │   │   │   ├── conventional-commits-adaptor.js.html
│           │   │   │   └── index.html
│           │   │   ├── github-resource-converter.js.html
│           │   │   ├── index.html
│           │   │   ├── lexical-entry.js.html
│           │   │   └── lexicon-factory.js.html
│           │   ├── prettify.css
│           │   ├── prettify.js
...
├── lib
│   ├── adaptor
│   │   └── conventional-commits-adaptor.js
│   ├── cli
│   │   ├── index.js
│   │   └── prep-dirs.js
│   ├── github-resource-converter.js
│   ├── db
│   │   └── en
│   │       ├── lexical-entry.json
│   │       └── lexion.json
...
│           ├── label-template.md
│           ├── page-template.md
│           ├── usage-ul-li-commit-log.html
│           ├── usage-ul-li-labels.html
│           ├── usage-ul-li-projects.html
│           └── usage-ul.html
├── markdown.config.js
├── node_modules
├── package-lock.json
...
[issues-new-feat-url]: /commonality/github-resource-converter.git/issues/new?title=feat%28scope%29%3A+summary-of-change&labels=priority%3A+medium%2Cstatus%3A+review+needed%2Ctype%3A+feature&body=%2A%2A%F0%9F%92%A1+TIP%3A%2A%2A+Select+the+%E2%86%96%EF%B8%8E%E2%8E%BE+Preview+%E2%8F%8B+Tab+above+help+read+these+instructions.%0D%0A%0D%0A%23%23+1.+Issue+type%0D%0A%3E%E2%8C%A6+Type+the+letter+%22x%22+in+the+%22checkbox%22+the+best+describe+this+issue.%0D%0A%0D%0A-+%5Bx%5D+**Feature%3A**+I%27m+requesting+a+product+enhancement.%0D%0A%0D%0A%23%23+2.+User+story+summary%0D%0A%3E%E2%8C%A6+Describe+what+you+want+to+accomplish%2C+in+what+role%2Fcapacity%2C+and+why+it%27s+important+to+you.%0D%0A%0D%0A%3E+**EXAMPLE%3A**%0D%0A%3E+As+a+Applicant%2C%0D%0A%3E+I+want+to+submit+my+resume%0D%0A%3E+In+order+to+be+considered+for+a+job+opening.%0D%0A%0D%0AAs+a+%7Brole%7D%2C%0D%0AI+must%2Fneed%2Fwant%2Fshould+%7Bdo+something%7D%0D%0AIn+order+to+%7Bachieve+value%7D.%0D%0A%0D%0A%23%23+3.+Acceptance+criteria%0D%0A%3E%E2%8C%A6+Replace+the+examples+below+with+your+own+imperative%2C+%22true%2Ffalse%22+statements+for+the+**behavior+you+expect**+to+see%2C+or+the+behavior+that+**would**+be+true+if+there+were+no+errors+%28for+defects%29.%0D%0A%0D%0A-+%5B+%5D+1.+Job+Applicants+receive+a+confirmation+email+after+they+submit+their+resumes.%0D%0A-+%5B+%5D+2.+An+Applicant%27s+resume+information+isn%27t+lost+when+errors+occur.%0D%0A-+%5B+%5D+3.+%7Bcriterion-three%7D%0D%0A-+%5B+%5D+4.+%7Bcriterion-four%7D%0D%0A%0D%0A%3C%21--+%E2%9B%94%EF%B8%8F++Do+not+remove+anything+below+this+comment.+%E2%9B%94%EF%B8%8F++--%3E%0D%0A%5Bicon-info-image%5D%3A+..%2Fdocs%2Fimg%2Ficons8%2Ficon-info-50.png%0D%0A
