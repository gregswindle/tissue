...
const baseResourceConverter = require('../lib/base-resource-converter')
const githubResourceLogger = require('../lib/github-resource-logger')
...
const restClientOptions = require('../lib/rest-client-options')
